...
public class CidadeControllerAPI {
    ...
    public ResponseEntity<Cidade>
        ...
        // cidadeAntigo.setCRM(cidade.getCRM());
        // cidadeAntigo.setListaProcedimentos(cidade.getListaProcedimentos());
        // cidadeAntigo.setCidade(cidade.getCidade());
        // cidadeAntigo.setListaPlanos(cidade.getListaPlanos());
